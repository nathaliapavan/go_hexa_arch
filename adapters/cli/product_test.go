...
import (
	"fmt"
	"github.com/nathaliapavan/go_hexa_arch/adapters/cli"
...
func TestRun(t *testing.T) {
	...
	resultExpected := fmt.Sprintf("Product ID %s with the same %s has been created with the price %f and status %s",
